<template>
  <header class="sticky top-0 shadow-lg border-b-2 border-secondary dark:border-dsecondary">
	<nav class="container flex flex-row sm:flex-row items-center justify-evenly py-4 min-w-full min-h-full">
